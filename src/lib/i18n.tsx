...
export const t: Dict = {
  tagline: { fr: "Le Canada, expliqué.", en: "Canada, explained." },
  ...
  newsletter_title: { fr: "Recevez Canada Daily chaque matin", en: "Get Canada Daily every morning" },
  newsletter_sub: {
    fr: "Une lettre quotidienne pour comprendre le Canada d'aujourd'hui.",
    en: "A daily letter to understand today's Canada.",
  },
  newsletter_cta: { fr: "S'abonner", en: "Subscribe" },
  email_placeholder: { fr: "votre@courriel.ca", en: "your@email.ca" },
  back_home: { fr: "Retour à l'accueil", en: "Back to home" },
  by: { fr: "Par", en: "By" },
  min_read: { fr: "min de lecture", en: "min read" },
  about_title: { fr: "À propos de Canada Daily", en: "About Canada Daily" },
  about_body: {
    fr: "Canada Daily est un magazine d'analyse fondé pour expliquer le Canada à ses lecteurs — en français comme en anglais. Inspiré par le journalisme explicatif moderne, nous croyons qu'une démocratie saine repose sur des citoyens informés. Nous couvrons la politique, l'économie, la culture et l'environnement avec rigueur, indépendance et clarté.",
    en: "Canada Daily is an analysis magazine founded to explain Canada to its readers — in both English and French. Inspired by modern explanatory journalism, we believe a healthy democracy rests on informed citizens. We cover politics, the economy, culture and the environment with rigor, independence and clarity.",
  },
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const saved = typeof window !== "undefined" ? (localStorage.getItem("canada-lang") as Lang | null) : null;
    if (saved === "fr" || saved === "en") setLangState(saved);
  }, []);

  const setLang = (l: Lang) => {
    setLangState(l);
    if (typeof window !== "undefined") localStorage.setItem("canada-lang", l);
  };
