  ...
  return (
    <footer className="mt-24 border-t border-border bg-foreground text-background">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-3 lg:px-8">
        <div>
          <div className="bg-foreground px-3 py-1 mb-4 w-fit">
            <span className="font-serif text-2xl font-black tracking-tighter text-vox-yellow">
              C
            </span>
          </div>
          <h2 className="font-serif text-2xl font-black uppercase tracking-tighter">Canada Daily</h2>
          <p className="mt-4 max-w-xs text-xs font-medium leading-relaxed text-muted-foreground">
            {tr("about_body").slice(0, 150)}...
          </p>
        </div>
